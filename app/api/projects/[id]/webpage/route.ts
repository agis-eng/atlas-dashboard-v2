      ...
      try {
        ...
        if (parsed) {
          draft = {
            ...
            seoLayer: typeof parsed.seoLayer === "object" && parsed.seoLayer ? parsed.seoLayer : draft.seoLayer,
